...
if __name__ == "__main__":
    ...
    token_ids, token_counts = english_ipa_tokenizer.encode("If you are running your training from a script, run the following command to create and save a configuration file.")
    tokens = english_ipa_tokenizer.decode(token_ids)
    print("".join(tokens))
    print(english_ipa_tokenizer.num_tokens)
